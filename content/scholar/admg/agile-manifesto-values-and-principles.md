---
title: "Agile Manifesto Values and Principles"
date: 2025-04-17
course: "ADMG 479"
...
The Agile Manifesto provides a foundational framework for agile project management, emphasizing adaptability, collaboration, and a customer-focused approach. It comprises four core values and twelve principles. Below, each is described and contextualized with examples from personal project experience. An acronym for AGILE proposed by Roula Lombardi is Adapt continually, Groom your requirements and refinements for release of features, Iterate through two-to-four-week scrum cycles, Launch and learn through deployment, and Empower your scrum teams (Lombardi, 2020).

## Four Core Values

**Individuals and Interactions Over Processes and Tools.** Agile methodologies prioritize direct communication and teamwork. In my experience, daily stand-up meetings significantly improved team coordination during our SaaS content projects, fostering open dialogue and rapid issue resolution. Lombardi (2020) emphasizes that agile's success in non-tech companies often stems from such interactive teamwork over rigid adherence to processes.
...
Lombardi, R. (2020). *Beyond agile: How to bring agile principles into non-tech companies.* Wiley.

Scrum.org. (2017). *The Scrum Guide.*

Yordanova, S., and Toshkov, B. (2019). Customer engagement in agile software development. *International Journal of Information Technologies and Systems Approach, 12*(1), 14–28.
